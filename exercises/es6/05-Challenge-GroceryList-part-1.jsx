...
class GroceryList extends React.Component {
  constructor(props) {
    ...
    this.state = {
      groceries: [
        { name: "Apples" },
        //{ name: "BlueBerries" }, // for testing
        //{ name: "Chips" } // for testing
      ]
    };
  }
  ...
  render() {
    ...
    console.log("Size of groceries: " + this.state.groceries.length)
...
class GroceryListItem extends React.Component {
  ...
  render() {
      console.log("grocery.." + this.props.grocery.name);
    return (
        <li>
